...
public class InvalidRaceException extends IllegalArgumentException {
    ...
    public static final String NUMBER_CUSTOM_MESSAGE = "경기 횟수는 (%d)번 이상이어야 합니다.";
    public static final String INVALID_NUMBER_CUSTOM_MESSAGE = "경기 횟수는 정수여야 합니다.";

    public InvalidRaceException(int time) {
        super(DEFAULT_MESSAGE + String.format(NUMBER_CUSTOM_MESSAGE, time));
    }
